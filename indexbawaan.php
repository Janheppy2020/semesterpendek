...
<body>
	...
	<div class="header-top">
		<div class="container">
			<div class="bottom_header_left">
				<p>
					<span class="fa fa-map-marker" aria-hidden="true"></span>Sekolah Menengah Pertama Primbana Medan
				</p>
			</div>
			<div class="bottom_header_right">
				...
				<div class="header-top-righ">
                	<a href="login.html"><span class="fa fa-book" aria-hidden="true"></span>Buku Tamu</a> &nbsp;
					<a href="login.html"><span class="fa fa-sign-out" aria-hidden="true"></span>Login</a>
				</div>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="?page=home">
							<h1>
								<span class="fa fa-leanpub" aria-hidden="true"></span>SMP PRIMBANA
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								<li>
									<a href="index.html" class="effect-3">Beranda</a>
								</li>
								<li class="dropdown">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li>
											<a href="#">Syarat Penerimaan Siswa baru</a>
										</li>
                                        <li>
											<a href="#">Prosedur Penerimaan Siswa baru</a>
										</li>
                                        <li>
											<a href="#">Jadwal Seleksi Siswa baru</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="join.html" class="effect-3">Registrasi</a>
								</li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">Info Hasil
										<span class="caret"></span>
									</a>
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="icons.html">Seleksi Berkas</a>
										</li>
										<li>
											<a href="codes.html">Seleksi Ujian</a>
										</li>
									</ul>
								</li>
                                <li>
									<a href="Gallery.html" class="effect-3">Daftar Ulang</a>
								</li>
                                <li>
									<a href="Gallery.html" class="effect-3">Siswa Baru</a>
								</li>
							</ul>
						</nav>
					</div>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<h3>S M P
							<span>Primbana Medan</span>
						</h3>
						<p>Mewujudkan Sekolah yang Unggul dalam Mutu, Prestasi dalam Kreasi, Teguh dalam Imtaq dan Berbudaya Ramah Lingkungan</p>
					</div>
				</div>
			</div>
	...
	<div class="banner-bottom-w3l" id="about">
		<div class="container">
			<div class="title-div">
				<h3 class="tittle">
					<span>W</span>elcome to <span>J</span>unior <span>H</span>igh <span>S</span>chool <span>P</span>rimbana <span>M</span>edan
				</h3>
			...
			<div class="welcome-sub-wthree">
				<div class="col-md-6 banner_bottom_left">
					...
					<p>Mewujudkan Sekolah yang Unggul dalam Mutu, Prestasi dalam Kreasi, Teguh dalam Imtaq dan Berbudaya Ramah Lingkungan</p>
                    <p></p>
					<h4><p><span>Visi SMP Primbana Medan</span></p></h4>
                    	<p>"Kreatif, Cerdas, Berprestasi, berbudaya, berbudi pekerti luhur, menguasai ilmu pengetahuan dan teknologi berlandaskan iman dan taqwa kepada Tuhan Yang Maha Esa"</p><p>&nbsp;</p>
                    <h4><p><span>Visi SMP Primbana Medan</span></p></h4>
                    <p>"Memberikan pelayanan prima untuk meningkatkan disiplin, kualitas, kemandirian dan prestasi"</p>
				</div>
				<!-- Stats-->
	...
	<div class="middle-sec-agile">
		<div class="container">
			<h4>Our
				<span>Best Study</span> SMP Primbana Medan</h4>
			<ul>
				<li>
			...
			<div class="container">
				<div class="mkls_footer_grid">
					<div class="col-xs-4 mkls_footer_grid_left">
						<h4>Location:</h4>
						<p>Jln. Jenderal Besar A.H Nasution No. 54 Pangkalan Mansyur
							<br> Kota Medan, Sumatera Utara</p>
					</div>
					<div class="col-xs-4 mkls_footer_grid_left">
						<h4>Mail Us:</h4>
						<p>
							<span>Phone : </span>061-7883945</p>
						<p>
							<span>Email : </span>
							<a href="mailto:smp_primbana_medan@yahoo.co.id">smp_primbana_medan@yahoo.co.id</a>
						</p>
					</div>
					<div class="col-xs-4 mkls_footer_grid_left">
						<h4>Id & Akreditas:</h4>
				...
				<div class="botttom-nav-allah">
					<ul>
						<li>
							<a href="#">"Kreatif, Cerdas, Berprestasi, berbudaya, berbudi pekerti luhur, menguasai ilmu pengetahuan dan teknologi berlandaskan iman dan taqwa kepada Tuhan Yang Maha Esa"</a>
						</li>
					</ul>
				</div>
				<!-- footer-button-info -->
				<div class="footer-middle-thanks">
					<h2>Thank's for your visit on our website</h2>
				</div>
				<!-- footer-button-info -->
			</div>
		</div>
		<div class="footer-copy-right">
			<div class="container">
				<div class="allah-copy">
                    ...
                    SMP Primbana Medan. All rights reserved | Design by
						<a href="#">Rut Adelina Br Sembiring</a>
					</p>
				</div>
