...
class M_registrasi extends CI_Model{
	...
	function get_all_registrasi(){
		$hsl=$this->db->query("SELECT * FROM tbl_registrasi,tbl_mahasiswa,tbl_makul_sespek,tbl_makul,tbl_dosen,tbl_ruangan WHERE tbl_registrasi.mahasiswa_id=tbl_mahasiswa.mahasiswa_id AND tbl_registrasi.makulsespek_id=tbl_makul_sespek.makulsespek_id AND tbl_makul_sespek.makul_id=tbl_makul.makul_id AND tbl_makul_sespek.dosen_id=tbl_dosen.dosen_id AND tbl_makul_sespek.ruangan_id=tbl_ruangan.ruangan_id AND registrasi_status='New'");
		return $hsl;
	}
	
	function get_all_registrasi_sempek(){
		$hsl=$this->db->query("SELECT * FROM tbl_registrasi,tbl_mahasiswa,tbl_makul_sespek,tbl_makul,tbl_dosen,tbl_ruangan WHERE tbl_registrasi.mahasiswa_id=tbl_mahasiswa.mahasiswa_id AND tbl_registrasi.makulsespek_id=tbl_makul_sespek.makulsespek_id AND tbl_makul_sespek.makul_id=tbl_makul.makul_id AND tbl_makul_sespek.dosen_id=tbl_dosen.dosen_id AND tbl_makul_sespek.ruangan_id=tbl_ruangan.ruangan_id AND registrasi_status='Diterima' order by tbl_registrasi.mahasiswa_id ASC");
		return $hsl;
	}
