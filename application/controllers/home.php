...
class Home extends CI_Controller{
	...
	function index(){
		...
		$x['tot_dosen']=$this->db->get('tbl_dosen')->num_rows();
		$x['tot_mahasiswa']=$this->db->get('tbl_mahasiswa')->num_rows();
		$x['tot_makul']=$this->db->get('tbl_makul')->num_rows();
		$x['tot_makul_sespek']=$this->db->get('tbl_makul_sespek')->num_rows();
