	...
	<div class="services-breadcrumb">
		<div class="inner_breadcrumb">
			<ul class="short_ls">
				...
				<li>Mahasiswa/i STMIK IBBI Medan</li>&nbsp; &nbsp;
                <li>|| &nbsp; &nbsp;<a href="<?php echo site_url('mahasisswa');?>" class="btn btn-primary"><b><font color="#FFFFFF">Log In Here</font></b></a></li>
			</ul>
		</div>
	</div>
	<!-- //short-->
		...
		<div class="container">
            <div class="gallery">
                <div class="container">
                    <div class="title-div">
                        <h3 class="tittle">
                            <span>M</span>ahasiswa <span>S</span>TMIK <span>I</span>BBI Medan
                        </h3>
                    ...
                    <div class="agileinfo-gallery-row">
                        ...
                        ?>
                        <div class="col-xs-2 w3gallery-grids">
                            <a href="#" class="imghvr-hinge-right figure">
                                <?php if(empty($photo)):?>
                                    <img width="160" height="170" src="<?php echo base_url().'assets/images/user_blank.png';?>"  alt="" />
                                <?php else:?>
                                    <img width="160" height="170" src="<?php echo base_url().'assets/images/'.$photo;?>"  alt="" />
                                <?php endif;?>
                        ...
                        <div class="clearfix"> </div>
                        	<div class="pginaiton pad9" align="center">
                     				<ul>
										<li class="pagination pagination-sm"><?php echo $page;?></li>
                                    </ul
                   			></div>
                        <div class="clearfix"> </div>
                    </div>
