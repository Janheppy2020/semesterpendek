	...
	<div class="services-breadcrumb">
		<div class="inner_breadcrumb">
			<ul class="short_ls">
				...
				<li>Prosedur Pendaftaran Mata Kuliah Semester Pendek Pada STMIK IBBI Medan</li>
			</ul>
		</div>
	</div>
	<!-- //short-->
			...
			<div class="about-sub">
				<div class="col-md-8 about_bottom_left">
					<div id="content2" align="justify">	
                                <img src="<?php echo base_url().'template/images/prosedur.jpg'?>"  alt="" width="709" height="450"/>
                                <!-- Blog Listing -->
                                <ul class="listing">
                                <?php
                                  $no=0;
