...
<title>Home || Sistem Informasi Semester Pendek IBBI Medan</title>
<!-- Stylesheet -->
                    	...
                    	<!-- Banner -->
                         ...
                         <!-- Content Heading -->
                         	<div class="content_heading">
                            	<div class="heading"><h2>Selamat datang di Jadwal Mata Kuliah Semester Pendek</h2> </div>
                          
                            </div>
                             <p class="text" align="justify">
                                 Website Jadwal Mata Kuliah Semester Pendek adalah website yang dibangun untuk Kampus STMIK IBBI Medan untuk menunjang transparasi informasi dan proses pelaksanaan jadwal mata kuliah semester pendek.  
                                 <p align="justify">Kami Menyambut baik terbitnya Website Jadwal Mata Kuliah Semester Pendek yang baru khususnya pada Jurusan Teknik Informatika Pada STMIK IBBI Medan , dengan harapan dipublikasinya website ini STMIK IBBI Medan berharap : Peningkatan layanan pendidikan kepada mahasiswa, orangtua, dan masyarakat pada umumnya semakin meningkat. Sebaliknya mahasiswa dengan mudah mengetahui jadwal mata kuliah pelaksanaan semester pendek. Dengan fasilitas ini Siswa dapat mengakses berbagai informasi pembelajaran dan informasi akademik.</p>
                             </p>
                          <div class="clear"></div>
                             <!-- Content Block -->
                	...
                	<div class="col2">
                    	<div class="ads">
                        	<a href="#"><img src="<?php echo base_url().'template/images/ads.png'?>"  alt="" /></a>
                      		...
                      		<!-- Blog guru dan Mahasiswa -->  
                            <?php $this->load->view('depan/v_blogguru_mahasiswa'); ?> 
                        	<!-- END Blog guru dan Mahasiswa -->
                    		<!-- Our College Gallery -->	
			...
			<!-- Slder -->	
            	<div class="image_scroll">
                	<a class="leftarrow" href="#"><img src="<?php echo base_url().'template/images/left_arrow.gif'?>"  alt="" /></a>
                    	<div class="slider1">
                        	<ul>
                    			    <li><a href="http://mfikri.com/"><img src="<?php echo base_url().'template/images/slider1.png'?>"  alt="" /></a></li>
                    			    <li><a href="http://mfikri.com/"><img src="<?php echo base_url().'template/images/slider2.png'?>"  alt="" /></a></li>
                    			    <li><a href="http://mfikri.com/"><img src="<?php echo base_url().'template/images/slider3.png'?>"  alt="" /></a></li>
                    			    <li><a href="http://mfikri.com/"><img src="<?php echo base_url().'template/images/slider4.png'?>"  alt="" /></a></li>
                              <li><a href="http://mfikri.com/"><img src="<?php echo base_url().'template/images/slider5.png'?>"  alt="" /></a></li>
                              <li><a href="http://mfikri.com/"><img src="<?php echo base_url().'template/images/slider6.png'?>"  alt="" /></a></li>
                    		</ul>
                        </div>  
