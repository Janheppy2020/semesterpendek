...
<body>
	...
	<div class="services-breadcrumb">
		<div class="inner_breadcrumb">
			<ul class="short_ls">
				...
				<li>Syarat-syarat Pengambilan Mata Kuliah Semester Pendek Pada STMIK IBBI Medan</li>
			</ul>
		</div>
	</div>
	<!-- //short-->
	...
	<div class="about-sec" id="about">
		<div class="container">
			<div class="title-div">
				<h3 class="tittle">
					<span>S</span>yarat-syarat
					<span>P</span>endaftaran Semester Pendek
				</h3>
			</div>
			<div class="about-sub">
				<div class="col-md-8 about_bottom_left">
					<div id="content2" align="justify">	
                     <h4>Syarat Mengikuti
						<span>M. Kuliah Semester Pendek</span>
					</h4>
                                <ul class="listing">
                                <?php
                                  $no=0;
