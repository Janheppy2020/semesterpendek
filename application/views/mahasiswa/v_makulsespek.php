        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header" align="center">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Informasi Daftar Mata Kuliah Semester Pendek Yang Bisa di Ambil <span class="fa fa-plus"></span></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $ruangnama;?></td>
                </tr>
				<?php endforeach;?>
                </tbody>
              </table>
