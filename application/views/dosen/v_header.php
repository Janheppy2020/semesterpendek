...
<header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg">DASHBOARD LECTURER</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              ...
              $q=$this->db->query("SELECT * FROM tbl_dosen WHERE dosen_id='$id_admin'");
              $c=$q->row_array();
          ?>
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'assets/images/'.$c['dosen_photo'];?>" class="user-image" alt="">
              <span class="hidden-xs"><?php echo $c['dosen_nama'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url().'assets/images/'.$c['dosen_photo'];?>" class="img-circle" alt="">

                <p>
                  <?php echo $c['dosen_nama'];?>
                  <?php if($c['dosen_level']=='11'):?>
                    <small>Dosen STMIK IBBI Medan</small>
                  <?php else:?>
                    <small>Author</small>
                  <?php endif;?>
                </p>
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?php echo base_url().'dossen/logout'?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
