...
<head>
  ...
  <title>Sekolah Tinggi Manajemen dan Informatika Komputer (STMIK IBBI) Medan | Jadwal dan Peserta Mata Kuliah Semester Pendek</title>
...
<div class="wrapper">
   ...
   <?php
    $this->load->view('dosen/v_header');
  ?>
  <!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    <?php $this->load->view('dosen/v_menu'); ?>
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Informasi Jadwal dan Peserta M.K Semester Pendek
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Informasi</a></li>
        <li class="active">Jadwal dan Peserta M.K Semester Pendek</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header" align="center">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal1"><span class="fa fa-plus"></span> Informasi Jadwal dan Peserta Pengambilan Mata Kuliah Semester Pendek Yang Telah Diterima <span class="fa fa-plus"></span></a>
              <!--<a class="btn btn-success btn-flat" data-toggle="modal" data-target="#ModalEdit"><span class="fa fa-print"></span> Cetak Bukti Pendaftaran</a>-->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <!-- /.content-wrapper -->
  <?php $this->load->view('dosen/v_footer'); ?>
