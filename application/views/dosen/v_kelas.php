...
<head>
  ...
  <title>Sekolah Tinggi Manajemen dan Informatika Komputer (STMIK IBBI) Medan | Kelas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kelas Mahasiswa</li>
      </ol>
    </section>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input type="text" name="xkelas" class="form-control" id="inputUserName" value="<?php echo $kelas_nama;?>" placeholder="Nama Kelas" required>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $kelas_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $kelas_id;?>"/>
                            <p>Apakah Anda yakin mau menghapus nama kelas ini <b><?php echo $kelas_nama;?></b> ?</p>
