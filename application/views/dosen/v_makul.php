        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header" align="center">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Informasi Daftar Keseluruhan  Mata Kuliah di STMIK IBBI Medan <span class="fa fa-plus"></span></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
